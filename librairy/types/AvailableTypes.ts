...
export type User = { id: 'integer'; username: 'string'; email: 'string'; password_hash: 'string'; created_at: 'string'; updated_at: 'string,null' };

export type Client = { id: 'integer'; name: 'string'; email: 'string'; phone: 'string'; created_at: 'string'; updated_at: 'string,null' };
